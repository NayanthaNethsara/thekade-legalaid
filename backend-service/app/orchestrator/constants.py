...
LANGUAGE_SCRIPT_RULES = {
    ...
    "singlish": (
        ...
        "- Mix English loanwords naturally (e.g., 'delivery fees', 'cart eka', "
        ...
        "(e.g., 'oyaa kaalada?' - did you eat, 'oyaa checkout kalaada?').\n"
        ...
        "(e.g., 'oyage order eka' - your order, 'oyage name eka').\n"
        ...
        "Examples:\n"
        "  * Natural: 'Mata oyaage order eka check karala kiyanna puluwan.' "
        "(Avoid stiff: 'Obage arakshitha anukaaya pariksha kireemata mata "
        "hakiyatha thibe.')\n"
        "  * Natural: 'Kohomada oyaata help karanna puluwan?'\n"
        "  * Natural: 'Item eka cart ekata add kala. Oyaata checkout karanna "
        "onida?'"
    ),
    "tanglish": (
