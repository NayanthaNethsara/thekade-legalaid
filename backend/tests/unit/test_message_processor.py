...
class TestMessageProcessor:
    ...
    async def test_process_text_message(self):
        ...
        with patch('app.services.message_processor.whatsapp_service') as mock_whatsapp:
            ...
            mock_whatsapp.send_text.assert_called_once_with(
                "1234567890", 
                "You said: Hello, I need legal help"
            )
    ...
    async def test_process_voice_message_success(self, mock_os_remove):
        ...
        with patch('app.services.message_processor.whatsapp_service') as mock_whatsapp, \
            ...
            mock_whatsapp.send_text = AsyncMock()
            mock_transcription.transcribe.return_value = "I need help with a traffic violation"
            ...
            mock_whatsapp.send_text.assert_called_once_with(
                "1234567890", 
                "Transcription: I need help with a traffic violation"
            )
    ...
    async def test_process_message_text_type(self):
        ...
        with patch.object(MessageProcessor, 'process_text_message') as mock_process_text:
    ...
    async def test_process_message_audio_type(self):
        ...
        with patch.object(MessageProcessor, 'process_voice_message') as mock_process_voice:
    ...
    async def test_process_message_unsupported_type(self):
        ...
        with patch('app.services.message_processor.WhatsAppService') as mock_whatsapp_class:
            ...
            mock_whatsapp_instance.send_text.assert_called_once_with(
                "1234567890",
                "Sorry, I only process text and voice messages for now. You sent a image."
            )
    ...
    async def test_process_message_no_type_field(self):
        ...
        with patch('app.services.message_processor.WhatsAppService') as mock_whatsapp_class:
            ...
            mock_whatsapp_instance.send_text.assert_called_once_with(
                "1234567890",
                "Sorry, I only process text and voice messages for now. You sent a None."
            )
    ...
    async def test_process_voice_message_download_error(self):
        ...
        with patch('app.services.message_processor.whatsapp_service') as mock_whatsapp, \
            ...
            mock_whatsapp.download_media = AsyncMock(side_effect=Exception("Download failed"))
            mock_whatsapp.send_text = AsyncMock()
            mock_transcription.transcribe = Mock()
