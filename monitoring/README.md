...
| `core-service:8002/metrics`     | Go (client_golang): default Go metrics + `core_incoming_messages_total`, `core_replies_published_total`             |
| `admin-service:8001/metrics`    | FastAPI (instrumentator): default HTTP metrics                                                                      |
