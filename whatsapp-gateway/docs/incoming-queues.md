...
All formats are published to a single JetStream stream, `LEGALAID_EVENTS`, on a
...
Each format has a thin producer that publishes to its configured subject:

| Format | Producer |
| --- | --- |
| text | [incoming-message-producer.ts](../src/modules/nats/incoming-message-producer.ts) |
| image | [incoming-image-producer.ts](../src/modules/nats/incoming-image-producer.ts) |
| video | [incoming-video-producer.ts](../src/modules/nats/incoming-video-producer.ts) |
| audio | [incoming-audio-producer.ts](../src/modules/nats/incoming-audio-producer.ts) |
| document | [incoming-document-producer.ts](../src/modules/nats/incoming-document-producer.ts) |
