...
export const validationSchema = Joi.object({
  ...
  NATS_SUBJECT_INCOMING_IMAGE: Joi.string().default('whatsapp.incoming.image'),
  NATS_SUBJECT_INCOMING_VIDEO: Joi.string().default('whatsapp.incoming.video'),
  NATS_SUBJECT_INCOMING_AUDIO: Joi.string().default('whatsapp.incoming.audio'),
