...
export const validationSchema = Joi.object({
  ...
  WHATSAPP_MEDIA_SUPPORTED: Joi.boolean().default(false),
  WHATSAPP_TYPING_REFRESH_MS: Joi.number().default(20000),
  WHATSAPP_TYPING_MAX_MS: Joi.number().default(300000),
  NATS_URL: Joi.string().required(),
  NATS_STREAM_NAME: Joi.string().default('KAKILLE_AGENT_EVENTS'),
